{inputs, ...}: {
  perSystem = {config, ...}: let
    ...
    # alongside the Cargo sources, which `cleanCargoSource` strips. Any new
    # static asset Trunk pulls in (images, fonts, additional .scss/.js) must be
    # added to this filter or the nix build will fail to find it.
